  ...
  return (
    ...
    >
      ...
      {ingestion_errors >= 0 && threshold !== undefined && threshold >= 0 && (
        <div className="bg-[var(--sc-section)] rounded-md p-3 space-y-3">
          ...
          <div className="relative pt-1">
            ...
            <div
              className="absolute top-0 w-0.5 h-5 bg-[var(--sc-text-primary)] rounded-full transition-all"
          ...
          <div className="flex text-[9px]">
            {SCALE_SEGMENTS.map((seg) => (
              <div key={seg.level} className={`${seg.width} text-center`}>
                ...
                <br />
                <span className="text-[var(--sc-text-muted)]">{seg.range}</span>
              </div>
            ))}
          </div>
        </div>
